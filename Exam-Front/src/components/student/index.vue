    ...
    <el-row class="shadow-md bg-white px-3.5">
      <el-col :span="24">
        <ul class="list text-gray-700 ">
          <li class="logo text-3xl font-bold flex text-blue-400" ><i class="iconfont icon-kaoshi " ></i><span>Exam-Online</span></li>
...
#student .list li{
 ...
 @apply transition duration-500 ease-in-out bg-white hover:bg-blue-200 transform hover:-translate-y-1 hover:scale-110 cursor-pointer;
}
